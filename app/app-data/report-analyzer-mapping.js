    	...
    	bch: [
    		...
    		},
    		{
    			...
    			compare: [
    				{
    					title: "",
    					url: "app-data/bch/report-analyzer/mapping/cpbNationalReport2.json"
    				}
    			]
    		},
    		{
    			...
    			compare: [
    				{
    					...
    					url: "app-data/bch/report-analyzer/mapping/cpbNationalReport3-2.json"
    				}
    			]
    		},
    		{
    			...
    			compare: [
    				{
    					...
    					url: "app-data/bch/report-analyzer/mapping/cpbNationalReport4-3.json"
    				},
    				{
    					title: "Compare with 2nd National Report Question",
    					url: "app-data/bch/report-analyzer/mapping/cpbNationalReport4-2.json"
    				}
    			],
    			offlineFormats: [
    				{
