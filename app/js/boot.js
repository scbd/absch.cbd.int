...
require.config({
    ...
    'paths': {
        ...
        'xlsx-js'                   : 'components/table-export/xlsx-js',
        'file-saverjs'              : 'components/table-export/file-saverjs',
        'tableexport'               : 'components/table-export/tableexport',
        'blobjs'                    : 'components/table-export/blobjs',
        'jzip'                      : 'components/table-export/jzip',
