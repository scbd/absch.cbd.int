...
//
//============================================================
require('app').directive('search2Schema', function ($http) {
    return {
        restrict: 'EAC',
        templateUrl: '/app/views/search2/search2-schema.partial.html?v892e42e',
        replace: true,
        // require : "?ngModel",
        scope: {
              // placeholder: '@',
...
//
//============================================================
require('app').directive('search2Facet', function ($http) {
    return {
        restrict: 'EAC',
        templateUrl: '/app/views/search2/search2-facet.partial.html?v892e14e22',
        replace: true,
        // require : "?ngModel",
        scope: {
              // placeholder: '@',
...
//
//============================================================
require('app').directive('bindIndeterminate', [function () {
    return {
        restrict: 'A',
