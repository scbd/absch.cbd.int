 ...
 'realm-configuration', '/app/services/app-config-service.js'], function (app, _) {
    ...
    app.config(['extendedRouteProvider', '$locationProvider', function ($routeProvider, $locationProvider) {
        ...
        $routeProvider.
           ...
           when('/register/:document_type/:documentID/view',           {templateUrl: '/app/views/register/register.html',          label:'View',  param:'true', resolveController: true,resolve : { securized : securize(null,true) },subTemplateUrl: '/app/views/register/record-history.html', }).
