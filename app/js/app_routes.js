 ...
 '/app/services/app-config-service.js'], function (app, _) {
    ...
    app.config(['extendedRouteProvider', '$locationProvider', function ($routeProvider, $locationProvider) {
        ...
        $routeProvider.
                ...
                when('/register/:document_type/status/:status',             {templateUrl: '/app/views/register/register.html',          label:'document_type',  param:'true', resolveController: true,resolve : { securized : securize(null,true) }}).
                ...
                when('/register/CNA/new',           {templateUrl: '/app/views/forms/edit/edit-authority.html',                 label:'New',  param:'true', resolveController: true,documentType :'CAN' , resolve : { securized : securize(null,true) }, }).
                ...
                when('/register/A19A20/new',        {templateUrl: '/app/views/forms/edit/edit-modelContractualClause.html',    label:'New',  param:'true', resolveController: true,documentType :'MCC' , resolve : { securized : securize() }, }).
                ...
                when('/register/CNA/:identifier/edit',           {templateUrl: '/app/views/forms/edit/edit-authority.html',                 label:'Edit',  param:'true', resolveController: true, documentType :'CAN' , resolve : { securized : securize(null,true) }, }).
                ...
                when('/register/A19A20/:identifier/edit',        {templateUrl: '/app/views/forms/edit/edit-modelContractualClause.html',    label:'Edit',  param:'true', resolveController: true, documentType :'MCC' , resolve : { securized : securize() }, }).
