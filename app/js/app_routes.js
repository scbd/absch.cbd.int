 ...
 'realm-configuration', '/app/services/app-config-service.js'], function (app) {
    ...
    app.config(['extendedRouteProvider', '$locationProvider', function ($routeProvider, $locationProvider) {
        ...
        $routeProvider.
           ...
           when('/register/tasks/:id',                                 {templateUrl: '/app/views/tasks/tasks-id.html',             label:'Submit Information',  param:'true', resolveController: true, resolve : { securized : securize() }}).
           when('/register/tasks/:id/:activity',                       {templateUrl: '/app/views/tasks/tasks-id-activity.html',    label:'Submit Information',  param:'true', resolveController: true, resolve : { securized : securize() }}).
           when('/register/dashboard',                                 {templateUrl: '/app/views/register/register.html',          label:'Submit Information',  param:'true', resolveController: true, resolve : { securized : securize() }, subTemplateUrl: '/app/views/register/dashboard.html',}).
           when('/dashboard',                                          {redirectTo:  '/register/dashboard'}).

           when('/register',                                           {templateUrl: '/app/views/register/register.html',          label:'Submit Information',  param:'true', resolveController: true,resolve : { securized : securize() },subTemplateUrl: '/app/views/register/dashboard.html',}).
           ...
           when('/admin/reported-records',                             {templateUrl: '/app/views/register/register.html',          label:'Reported Records',  param:'true', resolveController: true,resolve : { securized : securize(["AbsAdministrator", "AbsAdministrator-dev", "AbsAdministrator-trg"]) },subTemplateUrl: '/app/views/admin/reported-records.html'}).
            ...
            when('/submit/tasks/:id',                                 {templateUrl: '/app/views/tasks/tasks-id.html',             label:'Submit Information',  param:'true', resolveController: true, resolve : { securized : securize() }}).
            when('/submit/tasks/:id/:activity',                       {templateUrl: '/app/views/tasks/tasks-id-activity.html',    label:'Submit Information',  param:'true', resolveController: true, resolve : { securized : securize() }}).
            when('/submit/dashboard',                                 {templateUrl: '/app/views/register/register.html',          label:'Submit Information',  param:'true', resolveController: true,resolve : { securized : securize() },subTemplateUrl: '/app/views/register/dashboard.html',}).

            when('/submit',                                           {templateUrl: '/app/views/register/register.html',          label:'Submit Information',  param:'true', resolveController: true,resolve : { securized : securize() },subTemplateUrl: '/app/views/register/dashboard.html',}).
