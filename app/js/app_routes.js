...
define(['app','underscore', 'extended-route-provider','scbd-angularjs-services',
        'services', 'filters', 'realm-configuration', '/app/services/app-config-service.js'],
function (app, _) {
    ...
    app.config(['extendedRouteProvider', '$locationProvider', function ($routeProvider, $locationProvider) {
        ...
        $routeProvider.
            ...
            when('/help/manage/:term?', {templateUrl: '/app/views/help/forms/edit-help.html',resolveController: true,resolve : { securized : securize() }, label:'Forms Help'}).
            ...
            when('/help/edit/faq/:term?', {templateUrl: '/app/views/help/forms/glossary-term.html',resolveController: true,resolve : { securized : securize() }, schema:'help-faqs', label:'FAQs'}).
