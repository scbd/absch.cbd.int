...
export default function bootApp(window, require, defineX) {
    ...
    require.config({
        ...
        'paths': {
           ...
           'pdfjs-dist/build/pdf.worker': cdnHost + 'pdfjs-dist@2.0.489/build/pdf.worker.min ',       
            ...
            'clipboard'                 : `${cdnHost}clipboard@2.0.11/dist/clipboard.min`,
    ...
    defineX('flag-icons-css', [`css!https://cdn.jsdelivr.net/gh/lipis/flag-icons@7.2.3/css/flag-icons.min.css`]);
    ...
    defineX('bootstrap',[cdnHost + 'bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js'], (boostrap)=>{ return boostrap;});
