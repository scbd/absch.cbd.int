...
require.config({
    ...
    'paths': {
        ...
        'angular-animate'           : cdnHost + 'angular-animate@1.4.14/angular-animate.min',
        ...
        'angular-loading-bar'       : cdnHost + 'angular-loading-bar@0.9.0/src/loading-bar',
        ...
        'tableexport'               : cdnHost + 'tableexport@4.0.10/dist/js/tableexport.min',
