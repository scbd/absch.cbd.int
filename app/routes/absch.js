define(['app', './common-routes'], function (app, commonRoutes) { ;
    ...
    app.config(['$routeProvider', function ($routeProvider) {
        ...
        $routeProvider.
               ...
               whenAsync('/forums/ahteg-dsi/:threadId',    { templateUrl: 'views/forums/post-list-view.html'     ,label:'Thread-Subject', resolveController: true, resolve : { securized : commonRoutes.securize() }, forumId:17446, forumListUrl:'/forums/ahteg-dsi/', text:'AHTEG on DSI'}).
               ...
               whenAsync('/register/CBI/new',           {templateUrl: 'views/forms/edit/edit-capacityBuildingInitiative.html',          label:'New',  param:'true', resolveController: true, documentType :'CBI' ,       resolve : { securized : commonRoutes.securize(null, true, true) }, }).
               whenAsync('/register/A19A20/new',        {templateUrl: 'views/forms/edit/edit-modelContractualClause.html',              label:'New',  param:'true', resolveController: true, documentType :'A19A20',     resolve : { securized : commonRoutes.securize(null, true, true) }, }).
               whenAsync('/register/CPP/new',           {templateUrl: 'views/forms/edit/edit-communityProtocol.html',                   label:'New',  param:'true', resolveController: true, documentType :'CPP' ,       resolve : { securized : commonRoutes.securize(null, true, true) }, }).
               whenAsync('/register/NMCC/new',           {templateUrl: 'views/forms/edit/abs/edit-abs-national-model-contractual-clause.html',  label:'New',  param:'true', resolveController: true, documentType :'NMCC' ,      resolve : { securized : commonRoutes.securize(null, true, true) }, }).
               ...
               whenAsync('/register/CBI/:identifier/edit',           {templateUrl: 'views/forms/edit/edit-capacityBuildingInitiative.html',label:'Edit',  param:'true', resolveController: true, documentType :'CBI' , resolve : { securized : commonRoutes.securize(null, true, true) }, }).
               whenAsync('/register/A19A20/:identifier/edit',        {templateUrl: 'views/forms/edit/edit-modelContractualClause.html',    label:'Edit',  param:'true', resolveController: true, documentType :'A19A20' , resolve : { securized : commonRoutes.securize(null, true, true) }, }).
               whenAsync('/register/CPP/:identifier/edit',           {templateUrl: 'views/forms/edit/edit-communityProtocol.html',         label:'Edit',  param:'true', resolveController: true, documentType :'CPP' , resolve : { securized : commonRoutes.securize(null, true, true) }, }).
               whenAsync('/register/ORG/:identifier/edit',           {templateUrl: 'views/forms/edit/edit-organization.html',              label:'Edit',  param:'true', resolveController: true, documentType :'ORG' , resolve : { securized : commonRoutes.securize(null, true, true) }, }).
