...
app.config(["$routeProvider", function ($routeProvider) {
  ...
  whenAsync('/register/LFO/:identifier/edit',                      { ...mapView(angularViewWrapper),                    "label":routesLabels.edit,"param":"true","resolveController":true,"documentType":"LFO","resolve":{ ...abschRouteUrls.register_LFO_edit,                                 "securized":securize(null,true,true)}}).
