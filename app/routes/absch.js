...
const abschRouteUrls = {
  ...
  //  register_SMSR_edit                   : { component: ()=>asyncLogError(import('~/views/forms/edit/abs/edit-measure-status')) },
   ...
   register_LFO_edit                   : { component: ()=>asyncLogError(import('~/views/forms/edit/abs/edit-legalFramework')) },
...
app.config(["$routeProvider", function ($routeProvider) {
  ...
  whenAsync('/register/LFO/new',                                 { ...mapView(angularViewWrapper),                    "label":routesLabels.new,"param":"true","resolveController":true,"documentType":"LFO","resolve":{ ...abschRouteUrls.register_IRCC_edit,                                           "securized":securize(null,true,true)}}).
