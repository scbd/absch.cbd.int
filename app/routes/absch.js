...
app.config(["$routeProvider", function ($routeProvider) {
  ...
  whenAsync('/register/CDI/new',                                  { ...mapView(angularViewWrapper),                    "label":"New","param":"true","resolveController":true,"documentType":"CDI","resolve":{ ...abschRouteUrls.register_CBI_edit,                                            "securized":securize(null,true,true)}}). 
  ...
  whenAsync('/register/CDI/:identifier/edit',                     { ...mapView(angularViewWrapper),                    "label":"Edit","param":"true","resolveController":true,"documentType":"CDI","resolve":{ ...abschRouteUrls.register_CBI_edit,                                "securized":securize(null,true,true)}}). 
