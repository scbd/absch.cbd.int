...
app.config(["$routeProvider", function ($routeProvider) {
  ...
  whenAsync('/register/NR1/new',                                   { ...mapView(angularViewWrapper),                    "label":routesLabels.new,"param":"true","resolveController":true,"documentType":"NR","resolve":{ ...abschRouteUrls.register_NR1_edit,                                             "securized":securize(null,true,true)}}).
