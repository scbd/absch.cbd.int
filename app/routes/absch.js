...
app.config(["$routeProvider", function ($routeProvider) {
  ...
  whenAsync('/register/LFO/new',                                 { ...mapView(angularViewWrapper),                    "label":routesLabels.new,"param":"true","resolveController":true,"documentType":"MSR","resolve":{ ...abschRouteUrls.register_LFO_edit,                                           "securized":securize(null,true,true)}}).
