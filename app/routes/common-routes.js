...
app.config(["$routeProvider", "$locationProvider", function ($routeProvider, $locationProvider) {
  ...
  whenAsync('/register/admin/report-counts',                      { ...mapView(angularViewWrapper),                    "label":routesLabels.reportCounts,"resolve":{ ...commonRouteUrls.register_admin_report_counts,                      "securized":securize()},"param":"true","resolveController":true}). 
