...
app.config(["$routeProvider", "$locationProvider", function ($routeProvider, $locationProvider) {
  ...
  whenAsync('/search/:recordType',                                { ...mapView(angularViewWrapper),                    "label":routesLabels.search,"resolve":{ ...commonRouteUrls.search,                                           },"resolveController":true,"reloadOnSearch":false}). 
  ...
  whenAsync('/articles',                                          { ...mapView(angularViewWrapper),                    "label":routesLabels.announcements,"resolve":{ ...commonRouteUrls.articles,                                                    },"resolveController":true,"resolveUser":true}). 
  whenAsync('/articles/:id',                                      { ...mapView(angularViewWrapper),                    "label":routesLabels.articleTitle,"resolve":{ ...commonRouteUrls.articles,                                                 },"resolveController":true,"resolveUser":true,"param":"true"}). 
