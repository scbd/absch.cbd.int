...
const commonRouteUrls = {
    ...
    register_admin_tags                         : { component: ()=>asyncLogError(import('~/views/register/admin-tags/admin-tags')) },
...
app.config(["$routeProvider", "$locationProvider", function ($routeProvider, $locationProvider) {
  ...
  whenAsync('/reports/analyzer/:reportType?',                      { ...mapView(angularViewWrapper),                    "label":routesLabels.reportsAnalyzer,"resolve":{ ...commonRouteUrls.reports_analyzer,                                            },"resolveController":true}). 
  ...
  whenAsync('/register/admin-tags',                               { ...mapView(angularViewWrapper),                    "label":routesLabels.adminTags,"resolve":{ ...commonRouteUrls.register_admin_tags,                                              "securized":securize(['Administrator'])},"param":"true","resolveController":true}).
