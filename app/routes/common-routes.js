...
app.config(["$routeProvider", "$locationProvider", function ($routeProvider, $locationProvider) {
  ...
  whenAsync('/countries/status/:status',                          { ...mapView(angularViewWrapper),                    "label":routesLabels.countryProfiles,"resolve":{ ...commonRouteUrls.countries,                                     },"resolveController":true,"resolveUser":true, "reloadOnSearch":false }). 
