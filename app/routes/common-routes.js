...
app.config(["$routeProvider", "$locationProvider", function ($routeProvider, $locationProvider) {
  ...
  whenAsync('/register/shared-urls',                              { ...mapView(angularViewWrapper),                    "label":routesLabels.sharedUrls, "resolve": { ...commonRouteUrls.shared_urls, "securized": securize() }, "param": "true", "resolveController": true }).
