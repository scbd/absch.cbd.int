...
const commonRouteUrls = {
    ...
    register_request                            : { component: ()=>asyncLogError(import('~/views/register/workflow-request.vue')) },
    ...
    notifications                               : { component: ()=>asyncLogError(import('~/views/notifications/notifications')) },
    ...
    register_admin_triage                       : { component: ()=>asyncLogError(import('~/views/register/admin-triage-list.vue')) },
...
app.config(["$routeProvider", "$locationProvider", function ($routeProvider, $locationProvider) {
  ...
  whenAsync('/countries',                                         { ...mapView(angularViewWrapper),                    "label":routesLabels.countryProfiles,"resolve":{ ...commonRouteUrls.countries,                                                   },"resolveController":true,"resolveUser":true,"reloadOnSearch":false }). 
  ...
  whenAsync('/reports',                                           { ...mapView(angularViewWrapper),                    "label":routesLabels.reports,"resolve":{ ...commonRouteUrls.reports, user: currentUser()                           },"resolveController":true}). 
  whenAsync('/reports/analyzer/:reportType?',                     { ...mapView(angularViewWrapper),                    "label":routesLabels.reportsAnalyzer,"resolve":{ ...commonRouteUrls.reports_analyzer,  user: currentUser()         },"resolveController":true}). 
  ...
  whenAsync('/register/dashboard',                                { ...mapView(angularViewWrapper),                                                 "resolve":{ ...commonRouteUrls.register,                                          "securized":securize()},"param":"true","resolveController":true}). 
  ...
  whenAsync('/register/requests/:workflowId',                     { ...mapView(vueViewWrapper),                        "label":routesLabels.pendingRequests,"resolve":{ ...commonRouteUrls.register_request,                                           "securized":securize()},"param":"true","resolveController":true}). 
  whenAsync('/register/user-preferences/:tab?',                   { ...mapView(angularViewWrapper),                    "label":routesLabels.subscriptions,"resolve":{ ...commonRouteUrls.register_user_preferences_tab,                               "securized":securize()},"param":"true","resolveController":true}).
  whenAsync('/register/shared-urls',                              { ...mapView(angularViewWrapper),                    "label":routesLabels.mySharing, "resolve": { ...commonRouteUrls.shared_urls, "securized": securize() }, "param": "true", "resolveController": true }).
  ...
  whenAsync('/notifications/:id',                                 { ...mapView(angularViewWrapper),                    "label":routesLabels.registerNotifications,"resolve":{ ...commonRouteUrls.notifications,                                      "securized":securize()},"param":"true","resolveController":true}).  
  ...
  whenAsync('/register/admin/triage',                             { ...mapView(vueViewWrapper),                        "label":routesLabels.submissionTriage, "resolve":{ ...commonRouteUrls.register_admin_triage,                        "securized":securize(['Administrator'])},"param":"true","resolveController":true}). 
  ...
  whenAsync('/kb/kbSearch',                                           { ...mapView(vueViewWrapper),                        "label":"kbSearch",                        "resolve":{ ...commonRouteUrls.kbSearch,                                       },"param":"true","resolveController":true}).
