define(['app', './common-routes', 'angular-route'], function (app,commonRoutes) { 'use strict';
    ...
    app.config(['$routeProvider', function ($routeProvider) {
        ...
        $routeProvider.
               ...
               whenAsync('/register/SPCNA/new',                 {templateUrl: 'views/forms/edit/edit-authority.html',                 label:'New',  param:'true', resolveController: true,documentType :'SPCNA', resolve : { securized : commonRoutes.securize(null,true, true) }, }).
               ...
               whenAsync('/register/SPCNA/:identifier/edit',    {templateUrl: 'views/forms/edit/edit-authority.html',            label:'Edit',  param:'true', resolveController: true,documentType :'SPCNA',    resolve : { securized : commonRoutes.securize(null,true, true) }, }).
