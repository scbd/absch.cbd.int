define(['app', './common-routes', 'angular-route'], function (app,commonRoutes) { 'use strict';
    ...
    app.config(['$routeProvider', function ($routeProvider) {
        ...
        $routeProvider.
               ...
               whenAsync('/register/LDI/new',                   {templateUrl: 'views/forms/edit/bch/edit-laboratory-detection.html',  label:'New',  param:'true', resolveController: true,documentType :'LDI',   resolve : { securized : commonRoutes.securize(null,true, true) }, }).
               ...
               whenAsync('/register/LDI/:identifier/edit',      {templateUrl: 'views/forms/edit/bch/edit-laboratory-detection.html', label:'Edit',  param:'true', resolveController: true,documentType :'LDI',   resolve : { securized : commonRoutes.securize(null,true, true) }, }).
