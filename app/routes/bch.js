define(['app', './common-routes', 'angular-route'], function (app,commonRoutes) { 'use strict';
    ...
    app.config(['$routeProvider', function ($routeProvider) {
        ...
        $routeProvider.
               ...
               whenAsync('/register/BCP/new',                   {templateUrl: 'views/forms/edit/bch/edit-country-profile.html',      label:'New',  param:'true', resolveController: true,documentType :'BCP',   resolve : { securized : commonRoutes.securize(null,true, true) }, }).
               whenAsync('/register/CBA/new',                   {templateUrl: 'views/forms/edit/edit-capacityBuildingInitiative.html',      label:'New',  param:'true', resolveController: true,documentType :'CBA',   resolve : { securized : commonRoutes.securize(null,true, true) }, }).
