...
const bchRouteUrls = {
  ...
  register_NR5_new                     : { component: ()=>asyncLogError(import('~/views/forms/edit/bch/edit-national-report-5')) },
  ...
  register_NR5_identifier_edit         : { component: ()=>asyncLogError(import('~/views/forms/edit/bch/edit-national-report-5')) },
...
app.config(["$routeProvider", function ($routeProvider) {
  ...
  whenAsync('/register/NR5/new',                                  { ...mapView(angularViewWrapper),                    "label":routesLabels.new,"param":"true","resolveController":true,"documentType":"NR4","resolve":{ ...bchRouteUrls.register_NR5_new,                                            "securized":securize(null,true,true)}}).
  ...
  whenAsync('/register/NR5/:identifier/edit',                     { ...mapView(angularViewWrapper),                    "label":routesLabels.edit,"param":"true","resolveController":true,"documentType":"NR4","resolve":{ ...bchRouteUrls.register_NR5_identifier_edit,                                "securized":securize(null,true,true)}}).
