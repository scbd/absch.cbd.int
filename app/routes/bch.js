...
app.config(["$routeProvider", function ($routeProvider) {
  ...
  whenAsync('/register/NR5/new',                                  { ...mapView(angularViewWrapper),                    "label":routesLabels.new,"param":"true","resolveController":true,"documentType":"NR5","resolve":{ ...bchRouteUrls.register_NR5_new,                                            "securized":securize(null,true,true)}}).
  ...
  whenAsync('/register/NR5/:identifier/edit',                     { ...mapView(angularViewWrapper),                    "label":routesLabels.edit,"param":"true","resolveController":true,"documentType":"NR5","resolve":{ ...bchRouteUrls.register_NR5_identifier_edit,                                "securized":securize(null,true,true)}}).
