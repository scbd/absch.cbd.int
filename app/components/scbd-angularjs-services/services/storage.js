...
const storageT = mergeTranslationKeys(storageTranslations);
    ...
    app.factory("IStorage", ["$http", "$q", "authentication", "realm", 'cacheService', 'apiToken', '$location', function($http, $q, authentication, defaultRealm, cacheService, apiToken, $location) {
        //		return new function()
        //		{
