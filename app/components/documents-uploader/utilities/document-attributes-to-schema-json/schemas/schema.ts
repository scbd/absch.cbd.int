import type { DocError, DocumentAttributes, DocValue } from '~/types/components/documents-uploader/document-schema'
import type {
  KeywordType, ELink, UsageKey,
  Keywords, DocumentRequest,
  SubDocument
...
export default class Schema {
  ...
  constructor (documentAttrs: DocumentAttributes, keywordsMap: KeywordType[]) {
  ...
  */
  async getDocumentIdentifierByGUID (uniqueId: string | undefined): Promise<string> {
    ...
    const entry: [string, DocValue] | undefined = Object.entries(this.documentAttributes)
  ...
  */
  async findOrCreateContact (value: string | undefined | null): Promise<SubDocument[] | undefined> {
    if (value === undefined) { return }
