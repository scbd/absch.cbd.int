<template>
    <div class="border-0 mt-1">
        ...
        <div v-if="!loading && viewArticle">
            ...
            <cbd-view-article :article="viewArticle" :show-cover-image="showCoverImage" :cover-image-size="coverImageSize">
                <template #title>
                    <h1 v-if="viewArticle?.title">{{lstring(viewArticle.title, locale)}}<hr></h1>
                </template>
            </cbd-view-article>
