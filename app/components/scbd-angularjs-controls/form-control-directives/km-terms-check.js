            ...
            link: function($scope, $element, $attr, ngModelController) {
                            ...
                            if(term){
                                ...
                                if(allChildSelected){
                                    if(mySelectedChildren.length == term.narrowerTerms.length){
                                        ...
                                        $element.find('#chk_'+$filter('escape')(identifier)).prop('indeterminate', false)
                                    }
                                }
                                else{ 
                ...
                function setIndeterminanteParents(terms, val){
                    ...
                    _.forEach(terms, function(identifier){
                            ...
                            if(term && !($scope.selectedItems[identifier]||{}).selected){
                                ...
                                $element.find('#chk_'+$filter('escape')(identifier)).prop('indeterminate', hasChildSelected||val);
                            }
                ...
                function isSelectedOrIndertiminante(terms){
                    var has = _.find(terms, function(identifier){ 
                        return ($scope.selectedItems[identifier]||{}).selected||$element.find('#chk_'+$filter('escape')(identifier)).prop('indeterminate')==true
                    });
