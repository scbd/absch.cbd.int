define(['app','text!components/scbd-angularjs-controls/form-control-directives/km-rich-textbox.html','angular','angular-trix','css!components/scbd-angularjs-controls/form-control-directives/km-control.css'], function(app,template,angular) {
						...
						$scope.text = {};	
							...
							$scope.trixInitialize = function(e, ed){
								...
								e.target.toolbarElement.querySelector(".trix-button-group.trix-button-group--text-tools")
									...
									var errorMessage = "<p class='trix-dialog-error'>Please enter a valid URL starting with https:// or http://</p>";
