define(['app','underscore'], function (app, _) {
    ...
    app.controller('matrixController', ['$scope', 'authHttp','realm','$q','$filter',
        ...
        var scopeElements = [
                          ...
                          {"identifier":"01DA2D8E-F2BB-4E85-A17E-AB0219194A17",      "name":"Relationship with other instruments", elements:[]},
                          {"identifier":"08B2CDEC-786F-4977-AD0A-6A709695528D",      "name":"Access and/or prior informed consent", elements:[]},
                          {"identifier":"5427EB8F-5532-4AE2-88EE-5B9619917480",      "name":"Traditional knowledge associated with genetic resources", elements:[]},
                          {"identifier":"A896179F-833E-4F76-B3F4-81CC95C66592",      "name":"Benefit-sharing and/or mutually agreed terms", elements:[]},
    	...
    	var queryParameters = {
            'q': 'realm_ss:'+ realm.value.toLowerCase() + ' AND schema_s:measure AND government_s:ht',
