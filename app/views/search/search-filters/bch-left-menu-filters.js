		...
		biosafetyDecision: [
			...
			},
			{
				...
				query: {
					...
					fq: [
						"schema_s:dnaSequence AND title_EN_t:*"
					],
					searchFields: [
						"title_EN_t"
					],
			...
			},
			{
				...
				query: {
					...
					fq: [
						"schema_s:organism AND commonNames_EN_txt:*"
					],
					searchFields: [
						"commonNames_EN_txt"
					]
			...
			},
			{
				...
				query: {
					...
					fq: [
						"schema_s:organism AND scientificName_s:*"
					],
					searchFields: [
						"scientificName_s"
					]
		...
		modifiedOrganism: [
			...
			},
			{
				...
				query: {
					...
					fq: [
						"schema_s:modifiedOrganism AND uniqueIdentification_s:*"
					],
					searchFields: [
						"uniqueIdentification_t",
						"uniqueIdentificationVariants_txt"
					],
