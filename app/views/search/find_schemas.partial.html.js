    ...
    return {
        ...
        controller : ['$scope', '$element', '$location', 'Thesaurus', "IStorage", "guid", "$q", "Enumerable",
         ...
         function ($scope, $element, $location, Thesaurus, storage, guid, $q, Enumerable, $filter,_,realm, $routeParams, $route, commonjs,
                    thesaurusService, searchService)
        {

            /////////////////////////////////////////////////////
            //// SCOPE Declaration ONLY && any initializations///
            /////////////////////////////////////////////////////
            initializeFilters();
            initialize();
            ...
            // add watches only when selected.
            ...
            $scope.options  = {
                ...
                absSubjects             : function () { return loadDomainWithFacets('absSubjects', 'resource', 'absSubjects_s'); },
                languages               : function () { return loadDomainWithFacets('languages', 'resource', 'absSubjects_s');},
                mccResourceTypes        : function () { return Thesaurus.buildTree(loadDomainWithFacets('mccResourceTypes', 'modelContractualClause', 'resourceTypes_s'));},
                cppResourceTypes        : function () { return Thesaurus.buildTree(loadDomainWithFacets('cppResourceTypes', 'communityProtocol', 'resourceTypes_s'));},
            };

            //**********************************************************
            //////////////////////////////
            //// SCOPE Declaration ENDS///
            ////////////////////////////
            ...
            ////////////////////////////////////////////
            //// private functions * Declaration ONLY///
            ///////////////////////////////////////////
                ...
                function buildConditions () {
                    ...
                    if($scope.keyword){
                        conditions.push('(title_t:*' + $scope.keyword + '* OR description_t:*' + $scope.keyword + '* OR text_EN_txt:*' + $scope.keyword + '* OR uniqueIdentifier_s:*' + $scope.keyword.toLowerCase() + '*)');
                    }
            ...
            $scope.$watch('previewType', buildQuery);
