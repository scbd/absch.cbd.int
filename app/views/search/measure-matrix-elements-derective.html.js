    ...
    app.directive("measureMatrixElements", function() {
        return {
            ...
            function($scope, $q, thesaurus, Enumerable, $http, guid, commonjs, $element) {
                ...
                $scope.measureMainElements = mainElements
                function getABSMeasure() {
                        return [{
                            ...
                            "shortTitle": {},
                            "description": "Access to genetic resources",
                            "source": "",
                ...
                function newMeasureMatrix(){
                    ...
                    if($scope.binding.geneticResource){
                        var scopeElement = mainElements[0];
                        scopeElement.narrowerTerms = [];
                        // _.findWhere($scope.terms, {identifier}

                        if($scope.binding.geneticResource.answer){
                            scopeElement.narrowerTerms.push(
                                    {
                                        title   : { en:'Covers all types of genetic resource'},
                                        section : $scope.binding.geneticResource.section
                                    }
                                );
                        }
                        else{
                    ...
                    _.each($scope.binding.relevantElements, function(element){
                        // $scope.terms
                ...
                function getParentElement(identifier){
                    ...
                    return getParentElement(element.broaderTerms[0]);
                }
            }]
        };
    });
