        ...
        <table class="table">
            ...
            <tr>
                ...
                <td >
                    ...
                    Date:
                    <ng v-vue-ng:km-date v-model:ng-model="date" @ng-disabled="isDisabled()"
                        placeholder="select a date...."></ng>
                </td>
            </tr>
            <tr>
                <td >
                ...
                <td >
                    ...
                    <span v-if="enabled">
                        <ng v-vue-ng:km-value-ml v-model:value="ltext" :locales="locales"></ng>
                    </span>
