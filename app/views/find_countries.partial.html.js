      ...
      controller: ['$scope', '$element', '$location', 'commonjs', '$q',
        function($scope, $element, $location, commonjs, $q) {
          ...
          $scope.filterByType = function(entity) {
            return $scope.typeFilter == 'All' || $scope.typeFilter == 'isPartyToCBD' && !entity.isSignatory && !entity.isRatified || $scope.typeFilter == 'isSignatory' && entity.isSignatory || $scope.typeFilter == 'isRatified' && entity.isRatified || $scope.typeFilter == 'isInbetween' && entity.isInbetween;
          ...
          $scope.$watch('externalFilter', function(newValue, oldValue) {
            ...
            if(oldValue && newValue && oldValue.length > newValue.length){ //i.e filter had been removed.
                ...
                var country = _.where($scope.terms, {identifier: removedFilter[0]})
