define(['app','lodash', 'views/forms/edit/edit',
    ...
    app.controller("editAbsProcedure", ["$scope", "$http", "$filter", "$q", "$routeParams", "$controller", "$location", "realm", function($scope, $http, $filter, $q, $routeParams, $controller, $location, realm) {
