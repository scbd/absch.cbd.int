...
//
//============================================================
$compile.directive('cbdEditAuthority', ['authHttp', "URI", "guid", "$filter", "Thesaurus", function ($http, URI, guid, $filter, thesaurus) {
	return {
		restrict   : 'EAC',
		templateUrl: '/app/abs/directives/forms/form-authority.partial.html',
		replace    : true,
		transclude : false,
		scope      : {},
