		...
		controller : ["$scope", function ($scope)
		{
			function onOtherDecisionChanged (decisionTypes){
				...
				_.forEach(decisionTypes, function(decision){
					...
					if(identifier == "1B6F702C-0C68-4B53-BCA4-1DA4A25E23A8"){ $scope.isDecisionOnTransitOfLMOs	= true;}
					...
					// if(_.includes(identifiersForSectionI,identifier.toString())){ $scope.isShowDecisionDocument = true;}
