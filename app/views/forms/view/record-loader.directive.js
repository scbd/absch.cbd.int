			...
			controller: ['$scope', "$route", 'IStorage', "authentication", "$q", "$location", "commonjs", "$timeout",
				...
				function ($scope, $route, storage, authentication, $q, $location, commonjs, $timeout, $filter,
					...
					var schemaMapping = {
						...
						biosafetyNews				: 'views/forms/view/bch/main',
						biosafetyLaw				: 'views/forms/view/bch/main',
						biosafetyDecision	 		: 'views/forms/view/bch/main',
						nationalRiskAssessment	 	: 'views/forms/view/bch/main',
						cpbNationalReport2	 		: 'views/forms/view/bch/main',
						cpbNationalReport3	 		: 'views/forms/view/bch/main',
						cpbNationalReport4	 		: 'views/forms/view/bch/main',
						expert	 					: 'views/forms/view/bch/main',
						expertAssignment			: 'views/forms/view/bch/main',
						independentRiskAssessment	: 'views/forms/view/bch/main',
						modifiedOrganism	 		: 'views/forms/view/bch/main',
						dnaSequence	 				: 'views/forms/view/bch/main',
						organism	 				: 'views/forms/view/bch/main',
						laboratoryDetection	 		: 'views/forms/view/bch/main',
						biosafetyExpert		 		: 'views/forms/view/bch/main',
						countryProfile		 		: 'views/forms/view/bch/main',
