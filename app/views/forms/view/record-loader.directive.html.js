define(['app', 'text!views/forms/view/record-loader.directive.html',
	...
	'./view-history-directive.html',
    'js/common',
    'views/directives/document-metadata-directive.html',
		...
		return {
			...
			controller: ['$scope', "$route", 'IStorage', "authentication", "$q", "$location", "commonjs", "$timeout",
				...
				function ($scope, $route, storage, authentication, $q, $location, commonjs, $timeout, $filter,
					...
					var schemaMapping = {
						news: 'views/forms/view/view-news.directive.html',
						...
						focalpoint: 'views/forms/view/view-focalpoint.directive.html',
						meeting: 'views/forms/view/view-meeting.directive.html',
						statement: 'views/forms/view/view-statement.directive.html',
						pressrelease: 'views/forms/view/view-pressrelease.directive.html',
						new: 'views/forms/view/view-new.directive.html',
						notification: 'views/forms/view/view-notification.directive.html',
