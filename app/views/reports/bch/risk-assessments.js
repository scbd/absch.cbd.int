define(['app', 'lodash', 'text!./risk-assessments.html', 'services/main','views/forms/view/bch/view-lmo-reference.directive',
'angucomplete-alt','views/directives/block-region-directive'], function(app, _, template) { ;
