define(['app', 'text!./bch-header.html','lodash', 'ng-breadcrumbs', 'services/main', 'components/scbd-angularjs-services/main','components/scbd-angularjs-controls/main'], function (app, html, _) { ;
