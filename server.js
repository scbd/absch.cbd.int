...
app.use('(/en)?/app',                                express.static(`${__dirname}/dist/en`, { setHeaders: cacheControl.setCustomCacheControl }));
app.use('/ar/app',                                   express.static(`${__dirname}/dist/ar`, { setHeaders: cacheControl.setCustomCacheControl }));
app.use('/es/app',                                   express.static(`${__dirname}/dist/es`, { setHeaders: cacheControl.setCustomCacheControl }));
app.use('/fr/app',                                   express.static(`${__dirname}/dist/fr`, { setHeaders: cacheControl.setCustomCacheControl }));
app.use('/ru/app',                                   express.static(`${__dirname}/dist/ru`, { setHeaders: cacheControl.setCustomCacheControl }));
app.use('/zh/app',                                   express.static(`${__dirname}/dist/zh`, { setHeaders: cacheControl.setCustomCacheControl }));
